defmodule HTTP1RequestTest do
  ...
  describe "origin-form request target (RFC9112§3.2.1)" do
    ...
    # NOTE(@leostera): the HTTP spec doesn't specify how we will handle the IPv6
    # internally, so Nomad drops the brackets after parsing. Hence, the assert
    # is modified to not have the brackets.
    #
    # We also normalize/lowercase the address.
